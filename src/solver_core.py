...
Problem class: plain CVRPTW — capacitated vehicle routing with time windows.
Distance/cost is haversine great-circle distance converted to travel minutes
via an average-speed constant. Node 0 of the travel matrix is always the depot;
the depot is NOT a member of the ``stops`` list (its lat/lon come from params).
"""
